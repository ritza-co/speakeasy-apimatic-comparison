...
export class Client implements ClientInterface {
  ...
  public clientCredentialsManager?: ClientCredentialsManager;
  ...
  constructor(config?: Partial<Configuration>) {
    ...
    if (this._config.clientCredentialsCredentials) {
      this.clientCredentialsManager = new ClientCredentialsManager(
        this._config.clientCredentialsCredentials,
        this
      );
    }
  }
...
function getBaseUri(server: Server = 'default', config: Configuration): string {
  if (config.environment === Environment.Production) {
    ...
    if (server === 'access token server') {
      return 'https://api.bookstore.com/oauth';
    }
  }
