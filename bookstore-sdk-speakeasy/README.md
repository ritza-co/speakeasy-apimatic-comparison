...
- [booksAddBook](docs/sdks/books/README.md#addbook)
- [booksGetAllBooks](docs/sdks/books/README.md#getallbooks)
- [booksGetBookById](docs/sdks/books/README.md#getbookbyid)
- [booksUpdateBookCoverById](docs/sdks/books/README.md#updatebookcoverbyid)
- [ordersCreateOrder](docs/sdks/orders/README.md#createorder)
- [ordersGetAllOrders](docs/sdks/orders/README.md#getallorders)
- [ordersGetOrderById](docs/sdks/orders/README.md#getorderbyid)
- [ordersGetOrderStream](docs/sdks/orders/README.md#getorderstream)
...
async function run() {
    let result;
    try {
        result = await sdk.books.getAllBooks();
